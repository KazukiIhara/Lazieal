...
// You are totally free to apply whatever transformationResource_ matrix to want to the data (depending on the use of the transformationResource_ you may want to apply it to ClipRect as well!)
